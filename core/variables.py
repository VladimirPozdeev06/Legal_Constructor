...
VARIABLE_LABELS: dict[str, str] = {
    # ── Перевод оставшихся полей с транслита на русский (12.06.2026) ──
    "adres_cessionarij_dop":             "Адрес Цессионария (продолжение)",
    "adres_kvartiry_1":                  "Адрес Квартиры 1",
    "adres_kvartiry_2":                  "Адрес Квартиры 2",
    "cena_ddu_cifr":                     "Цена по ДДУ (цифрами)",
    "cena_ddu_prop":                     "Цена по ДДУ (прописью)",
    "cena_dogovora_ciframi":             "Цена договора (цифрами)",
    "cena_dogovora_propisju":            "Цена договора (прописью)",
    "cena_ustupki_cifr":                 "Цена уступки (цифрами)",
    "cena_ustupki_nds_cifr":             "Цена уступки с НДС (цифрами)",
    "cena_ustupki_nds_prop":             "Цена уступки с НДС (прописью)",
    "cena_ustupki_prop":                 "Цена уступки (прописью)",
    "chisla":                            "Число",
    "data_egrn_1":                       "Дата выписки ЕГРН (объект 1)",
    "data_egrn_2":                       "Дата выписки ЕГРН (объект 2)",
    "data_peredachi_konkretnaya":        "Конкретная дата передачи",
    "data_pravoustan_dokumenta":         "Дата правоустанавливающего документа",
    "data_vypiski_egrn":                 "Дата выписки из ЕГРН",
    "den_akt":                           "День акта (число)",
    "den_dogovora":                      "День договора (число)",
    "edinica_izmerenija_sroka":          "Единица измерения срока (дни/месяцы)",
    "etazh_1":                           "Этаж (Квартира 1)",
    "etazh_2":                           "Этаж (Квартира 2)",
    "god_akt":                           "Год акта",
    "god_dogovora":                      "Год договора",
    "god_peredachi":                     "Год передачи",
    "if_not_sootvetstvuet":              "Если состояние не соответствует — описание",
    "inye_prilozheniya":                 "Иные приложения",
    "kadastrovyj_nomer_1":               "Кадастровый номер (Квартира 1)",
    "kadastrovyj_nomer_2":               "Кадастровый номер (Квартира 2)",
    "kadastrovyj_nomer_kvartiry":        "Кадастровый номер квартиры",
    "kolichestvo_komnat_1":              "Количество комнат (Квартира 1)",
    "kolichestvo_komnat_2":              "Количество комнат (Квартира 2)",
    "kolichestvo_mesyatsev":             "Количество месяцев",
    "kopeyki":                           "Копейки",
    "kto_platit_registraciju":           "Кто оплачивает регистрацию",
    "meropriyatie_ustranenie_1":         "Мероприятие по устранению недостатков 1",
    "meropriyatie_ustranenie_2":         "Мероприятие по устранению недостатков 2",
    "mesyac_akt":                        "Месяц акта",
    "mesyac_dogovora":                   "Месяц договора",
    "mesyac_peredachi":                  "Месяц передачи",
    "moment_ischisleniya_sroka":         "Момент исчисления срока",
    "moment_perehoda_riska":             "Момент перехода риска",
    "moment_riska":                      "Момент перехода риска",
    "naimenovanie_organa_registracii":   "Наименование органа регистрации",
    "nalichie_pretenzij":                "Наличие претензий",
    "nds_procent":                       "НДС, %",
    "ne_sootvetstvuet":                  "Состояние не соответствует — описание",
    "nomer":                             "Номер",
    "nomer_pril_1":                      "Номер приложения 1",
    "nomer_pril_2":                      "Номер приложения 2",
    "nomer_prilozheniya_akt":            "Номер приложения (акт)",
    "obshaya_ploshhad_1":                "Общая площадь (Квартира 1)",
    "obshaya_ploshhad_2":                "Общая площадь (Квартира 2)",
    "obshaya_ploshhad_bez_letnih":       "Общая площадь без летних помещений",
    "opisanie_nedostatkov":              "Описание недостатков",
    "organ_registracii_1":               "Орган регистрации (объект 1)",
    "organ_registracii_2":               "Орган регистрации (объект 2)",
    "organ_registracii_polnoe":          "Орган регистрации (полное наименование)",
    "organ_registracii_prav_nazvanie":   "Наименование органа регистрации прав",
    "ostavsheesya_imushhestvo":          "Остающееся имущество",
    "peni_pokupatelja_procent":          "Пени Покупателя, %",
    "peni_prodavca_procent":             "Пени Продавца, %",
    "peni_prodavca_za_nedostatki":       "Пени Продавца за недостатки",
    "peni_za_prosrochku":                "Пени за просрочку",
    "peni_za_prosrochku_propis":         "Пени за просрочку (прописью)",
    "peredannye_dokumenty_i_prinadlezhnosti": "Переданные документы и принадлежности",
    "peredavaemye_dokumenty":            "Передаваемые документы",
    "peredavaemye_dokumenty_akt":        "Передаваемые документы (акт)",
    "peredavaemyj_dokument_1":           "Передаваемый документ 1",
    "peredavaemyj_dokument_2":           "Передаваемый документ 2",
    "peredavaemyj_dokument_3":           "Передаваемый документ 3",
    "peredavaemyj_dokument_4":           "Передаваемый документ 4",
    "peredavaemyj_dokument_5":           "Передаваемый документ 5",
    "peredavaemyj_dokument_6":           "Передаваемый документ 6",
    "platezh_1_srok":                    "Платёж 1 — срок",
    "platezh_1_summa":                   "Платёж 1 — сумма",
    "platezh_2_srok":                    "Платёж 2 — срок",
    "platezh_2_summa":                   "Платёж 2 — сумма",
    "platezh_3_srok":                    "Платёж 3 — срок",
    "platezh_3_summa":                   "Платёж 3 — сумма",
    "poluchatelya_ili_platelschika_renty": "Получатель / плательщик ренты",
    "poradok_ustraneniya_1":             "Порядок устранения недостатков 1",
    "poradok_ustraneniya_2":             "Порядок устранения недостатков 2",
    "pravoustanavlivayushhij_dokument_1": "Правоустанавливающий документ (объект 1)",
    "pravoustanavlivayushhij_dokument_2": "Правоустанавливающий документ (объект 2)",
    "prilozhenie_akt":                   "Приложение (акт)",
    "razmer_doplaty":                    "Размер доплаты",
    "razmer_doplaty_propis":             "Размер доплаты (прописью)",
    "registracionnyj_nomer_egrn_1":      "Регистрационный номер ЕГРН (объект 1)",
    "registracionnyj_nomer_egrn_2":      "Регистрационный номер ЕГРН (объект 2)",
    "rosreestr":                         "Росреестр (наименование органа)",
    "sostoyanie_sootvetstvuet":          "Состояние квартиры соответствует — описание",
    "srok_fors_major":                   "Срок форс-мажора",
    "srok_fors_mazhor":                  "Срок форс-мажора",
    "srok_peredachi":                    "Срок передачи",
    "srok_peredachi_dney":               "Срок передачи, дней",
    "srok_peredachi_sobytie":            "Срок передачи (событие)",
    "srok_ustranenija_nedostatkov":      "Срок устранения недостатков",
    "srok_ustraneniya_1":                "Срок устранения недостатков 1",
    "srok_ustraneniya_2":                "Срок устранения недостатков 2",
    "srok_ustraneniya_den_1":            "Срок устранения 1 — день",
    "srok_ustraneniya_den_2":            "Срок устранения 2 — день",
    "srok_ustraneniya_god_1":            "Срок устранения 1 — год",
    "srok_ustraneniya_god_2":            "Срок устранения 2 — год",
    "srok_ustraneniya_mesyac_1":         "Срок устранения 1 — месяц",
    "srok_ustraneniya_mesyac_2":         "Срок устранения 2 — месяц",
    "stepen_rodstva":                    "Степень родства",
    "stoimost_kvartiry":                 "Стоимость квартиры",
    "stoimost_kvartiry_1":               "Стоимость Квартиры 1",
    "stoimost_kvartiry_1_propis":        "Стоимость Квартиры 1 (прописью)",
    "stoimost_kvartiry_2":               "Стоимость Квартиры 2",
    "stoimost_kvartiry_2_propis":        "Стоимость Квартиры 2 (прописью)",
    "storona_platit_registraciyu":       "Сторона, оплачивающая регистрацию",
    "summa_":                            "Сумма",
    "summa_rubli":                       "Сумма (рубли)",
    "svedeniya_ob_obremineniyakh":       "Сведения об обременениях",
    "tip_sroka_peredachi":               "Тип срока передачи",
    "uslovie_doplaty":                   "Условие доплаты",
    "uslovie_sostoyaniya_kvartir":       "Условие о состоянии квартир",
    "zapis_registracii_egrn":            "Запись регистрации в ЕГРН",
    "zaregistrirovannye_lica_kv1":       "Зарегистрированные лица (Квартира 1)",
    "zhilaya_ploshhad_1":                "Жилая площадь (Квартира 1)",
    "zhilaya_ploshhad_2":                "Жилая площадь (Квартира 2)",
    # ── Реквизиты договора ────────────────────────────────────────────────
    ...
    "email_storona1":             "Эл. почта Стороны 1",
    ...
    "email_storona2":             "Эл. почта Стороны 2",
    ...
    "email_prodavec":             "Эл. почта Продавца",
    "telefon_pokupatel":          "Телефон Покупателя",
    "email_pokupatel":            "Эл. почта Покупателя",
    ...
    "email_cedent":                "Эл. почта цедента",
    "email_cessionarij":           "Эл. почта цессионария",
    "email_platelschik_renty":     "Эл. почта плательщика ренты",
    "email_poluchatel_renty":      "Эл. почта получателя ренты",
